...
namespace MeshCutter
{
    public class MeshCutter : MonoBehaviour
    {
        ...
        /// <summary>
        /// Creates a plane in world space based off parameters
        /// </summary>
        /// <param name="point1">Plane passes through this point</param>
        /// <param name="point2">Plane passes through this point</param>
        /// <param name="planeAxis">Axis where the cross product of it and the vector of the two points = plane's normal</param>
        /// <returns>Newly created world-space plane</returns>
        public static Plane createPlane(Vector3 point1, Vector3 point2, Vector3 planeAxis)
        {
            return new Plane(Vector3.Cross(planeAxis, point2 - point1).normalized, point1);
        }
